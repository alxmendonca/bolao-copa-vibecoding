    ...
    <div className="home-page-wrap">
      <header className="hero">
        <div className="hero-inner">
          <p className="hero-kicker">BOLIN BET — Copa do Mundo 2026</p>
      ...
      <div className="main" style={{ paddingTop: "1rem" }}>
        <div
          className="alert-box alert-box--success"
          style={{ marginBottom: "2rem" }}
        >
          <p style={{ margin: 0, display: "flex", flexWrap: "wrap", alignItems: "center", gap: "10px" }}>
            <strong>🏆 Novidade Online!</strong>
            <span>Você pode criar uma Liga Online persistente com ranking automático em tempo real para convidar seus amigos.</span>
            <Link to="/league/new" className="btn btn-primary" style={{ fontSize: "0.8rem", padding: "0.3rem 0.75rem", textDecoration: "none" }}>
              Criar Liga Online
            </Link>
          </p>
        </div>
